...
INSERT INTO "new_ProductionOrder" ("articleId", "bMallDozen", "cMallDozen", "closedAt", "completedDozen", "createdAt", "department", "forwardedDozen", "id", "isClosed", "laborId", "packingLaborId", "packingPricePerDozen", "pricePerDozen", "quantityDozen", "source", "stage", "updatedAt") SELECT "articleId", "bMallDozen", "cMallDozen", "closedAt", "completedDozen", "createdAt", "department", "forwardedDozen", "id", "isClosed", "laborId", "packingLaborId", "packingPricePerDozen", "pricePerDozen", "quantityDozen", "source", "stage", "updatedAt" FROM "ProductionOrder";
