...
INSERT INTO "new_ExpenseEntry" ("amount", "categoryId", "chemicalPurchaseId", "createdAt", "date", "description", "id", "laborAdvanceId", "laborId", "materialPurchaseId", "module", "partyId", "rexinePurchaseId", "source", "sourceSystem") SELECT "amount", "categoryId", "chemicalPurchaseId", "createdAt", "date", "description", "id", "laborAdvanceId", "laborId", "materialPurchaseId", "module", "partyId", "rexinePurchaseId", "source", "sourceSystem" FROM "ExpenseEntry";
