-- AlterTable
ALTER TABLE "Bill" ADD COLUMN "verifiedAt" DATETIME;
...
INSERT INTO "new_PartyLedgerEntry" ("balance", "chemicalPurchaseId", "createdAt", "date", "description", "id", "materialPurchaseId", "partyId", "reference", "rexinePurchaseId") SELECT "balance", "chemicalPurchaseId", "createdAt", "date", "description", "id", "materialPurchaseId", "partyId", "reference", "rexinePurchaseId" FROM "PartyLedgerEntry";
